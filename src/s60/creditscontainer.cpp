...
void CCreditsContainer::Draw( const TRect& aRect ) const
	...
	DrawText( _L("Concept & Design:"), 0, iEikonEnv->LegendFont() );
	...
	DrawText( _L("BayXSonic"), 75, iEikonEnv->DenseFont() );
	DrawText( _L("bayxsonic.hotelteti.com"), 90, iEikonEnv->DenseFont() );
...
/*    //
    ...
    gc.DrawText(_L("FlashSms 0.99a"),rect,font->AscentInPixels(),CGraphicsContext::ECenter);
